...
import gana from "../../src/styles/images/gana.png";
import bgImg from "../assets/bck.png";
import ganatalent from "../../src/styles/images/ganatalent.png";
import ganagrp from "../../src/styles/images/ganagrp.png";
  ...
  return (
    <div className="bg-white">
            ...
            <div className="col-12">
              <div className="banner-sec flex flex-col items-center justify-between lg:flex-row">
                ...
                <div className="d-flex  align-items-center justify-content-center relative right-[-2rem]">
                  <img src={gana} className="w-[60rem]" />
                  {/* <img
      ...
      <section className="my-5" >
        <img src={ganatalent} alt="img" style={{margin:'auto'}} />
        <div
          className="container"
        ...
        >
          <div className="row">
            <div className="col-lg-6 my-auto">
              <img src={ganagrp} alt="img" className="img-fluid " />
            </div>
