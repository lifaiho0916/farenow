...
export const ServiceProviders = (props) => {
  ...
  useEffect(() => {
    ...
    if (location?.state?.service_type === ServiceType.MOVING) {
      console.log("from service provider jsx");
  ...
  const handleAddressChange = (address) => {
    if (address.length < 5) {
      ...
      setState((state) => ({
        ...state,
        addressErr: (
          <div className="col-md-12 text-danger mt-2" style={{ fontSize: 15 }}>
  ...
  const handleMoreDetailChange = (e) => {
    ...
    if (name == "phone") {
      ...
      if (regex.test(value)) {
        ...
        setState({
          ...state,
          [`${name}Err`]: value == "" ? "Required" : "e.g. +923331234567",
        });
      }
    }
    setState((state) => ({ ...state, [name]: value }));
  ...
  const handleLoadMoreClick = (page) => {
    dispatch(
      getProviderList(!!location?.search && `${location?.search}&page=${page}`)
    );
    window.scrollTo(0, 0);
  };
    ...
    <>
          ...
          <div className="row">
                ...
                <div className="service-time-box">
                  <div className="date-ser mb-4">
                    ...
                    <div className="time-list-pro">
                      ...
                      <div className="mx-2 select-time">Within 3 days</div>
                      <div className="mx-2 select-time">Within a week</div>
            ...
            <div className="col-md-8">
              ...
              providerList?.data?.data?.length ? (
                providerList.data.data.map((provider, index) => {
                  return (
                      ...
                      <div className="user-des d-flex align-items-center justify-content-start w-100">
                        ...
                        <div className="user-detail w-100">
                          <div className=" w-100 d-flex align-items-center justify-content-between">
                            ...
                            <Link
                              to={`/provider/profile/${
                                provider.first_name.toLowerCase() +
                                "-" +
                              ...
                              <div className="top-reviews-list">
                                ...
                                <div className="review-item d-flex align-itmes-centetr justifu-content-between">
                                  <div className="review-img">
                                    <img
                                      src={
                                        (provider?.user_feedbacks[0]?.user
                                          ?.image &&
                ...
                <>
                  {(() => {
                    Swal.fire({
                      title: "Error",
                      text: serviceRequest?.message || "Not found provider",
                      confirmButtonText: "Close",
                      icon: "error",
                      confirmButtonColor: "#fea629",
                      showCloseButton: true,
              ...
              {providerList?.data?.current_page !=
                ...
                <center>
                  <button
                    className="button-common"
                    onClick={() =>
                      handleLoadMoreClick(providerList?.data?.current_page + 1)
                    }
                  >
                    Load More
                  </button>
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-md-12">
                  <div className="row">
                    <center className="col-12">{state.questionsErr}</center>
                      ...
                      >
                        ...
                        {providerSchedule?.error && (
                          <div className="text-center text-danger">
                            ...
                            {providerSchedule?.message || "No Schedule Found"}
                          </div>
                        )}
                        {(() => {
        ...
        >
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button
                data-dismiss={
                  serviceRequest.message == "success" ? "modal" : ""
                }
                disabled={
                  state.addressErr !== "" ||
                  state.address === "" ||
      ...
      >
        ...
        >
          <div className="modal-content">
            <div className="modal-header">
              <h3 className="modal-title display-4" id="exampleModalLongTitle">
                Moving Request
              </h3>
              <button
                type="button"
