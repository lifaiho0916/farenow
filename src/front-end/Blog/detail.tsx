...
const postComment = async (
  comment: IWriteCommentData & { blog_id: number; comment_id?: number }
) => {
...
export default function BlogDetail(props: IBlogDetailProps) {
  ...
  const commentsQuery = useQuery(["blog-comments", slug], () =>
    fetchComments(slug)
  );
        ...
        <div className="w-[75%] mx-auto">
          <div className=" blog-container space-y-16">
            <div className="px-4">
              ...
              {/* <div className="text-base font-bold text-primary-main mt-3">
                Blog Post
              </div> */}
              <div className="text-primary-main text-xl grow my-2">
                {blog?.category?.name || <Skeleton />}
              </div>
              <h1 className="text-4xl">{blog?.title || <Skeleton />}</h1>
